...
Результаты выполнения тестов доступны по ссылке: [Allure report](https://borisborisa.github.io/ui_autotests_selenium/).
...
```
git clone https://github.com/BorisBorisa/ui_autotests_selenium.git
cd ui_autotests_selenium
```
